variable "windows_virtual_machine_name" {
  description = "The main name for the Windows Virtual Machine."
  type        = string
}
...
variable "windows_virtual_machine_prefix" {
...
variable "enable_automatic_updates" {
  description = "Specifies whether automatic updates are enabled for the Windows Virtual Machine."
  type        = bool
  default     = true
}

variable "patch_mode" {
  description = "Specifies the mode of in-guest patching. Possible values are Manual, AutomaticByOS, and AutomaticByPlatform."
  type        = string
